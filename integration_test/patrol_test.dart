...
//       await $.tap(find.byKey(
//         const Key('google_drive_backup'),
//       ));
//       await $.pumpAndSettle();

//       await $.tap(find.byIcon(Icons.login));
//       await $.pumpAndSettle();

//       await $.native.tap(const Selector(textContains: 'Werner'));
...
// Future<void> testImport(PatrolTester $) async {
//   //Navigate to the settigns tab.
//   await $.tap(find.byKey(
//     const Key('settings_tab'),
//   ));
