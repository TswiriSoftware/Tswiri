...
class WipHiveDatabaseView extends StatefulWidget {
  const WipHiveDatabaseView({Key? key}) : super(key: key);

  @override
  _WipHiveDatabaseViewState createState() => _WipHiveDatabaseViewState();
}

class _WipHiveDatabaseViewState extends State<WipHiveDatabaseView> {
  var displayList = [];
  @override
