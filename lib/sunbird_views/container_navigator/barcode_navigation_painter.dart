...
//   final List<RealBarcodePosition> containingGrid;
...
//         double referenceBarcodeMMperOIU = calculateRealUnit(
//           diagonalLength:
...
//         int indexOfReferenceBarcode = containingGrid.indexWhere(
...
//           RealBarcodePosition referenceBarcodeRealPositionEntry =
//               containingGrid[indexOfReferenceBarcode];

//           //iv. Get the referenceBarcodeRealPosition Offset.
//           Offset referenceBarcodeRealPosition =
//               referenceBarcodeRealPositionEntry.offset!;
...
//           RealBarcodePosition selectedarcodeRealPositionEntry = containingGrid
...
//               selectedarcodeRealPositionEntry.offset!;
