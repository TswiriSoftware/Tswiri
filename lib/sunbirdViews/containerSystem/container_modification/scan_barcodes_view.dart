...
class ScanBarcodesView extends StatefulWidget {
  const ScanBarcodesView({Key? key}) : super(key: key);

  @override
  _ScanBarcodesViewState createState() => _ScanBarcodesViewState();
}

class _ScanBarcodesViewState extends State<ScanBarcodesView> {
