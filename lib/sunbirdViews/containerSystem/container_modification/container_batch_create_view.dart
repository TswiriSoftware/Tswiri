...
import 'package:flutter_google_ml_kit/sunbirdViews/containerSystem/container_modification/scan_barcodes_view.dart';
                        ...
                        InkWell(
                          onTap: (() async {
                            scannedBarcodeUIDs = await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ScanBarcodesView(),
                              ),
                            );
                            setState(() {
                              numberOfBarcodes =
